        ...
        <div class="fjai-modal" style="position: relative;">
            ...
            <div class="fjai-header">
                <div class="fjai-logo">
                    ...
                    <div class="fjai-logo-text">FakeJob<span>AI</span></div>
                </div>
                <h2 class="fjai-title">Protect Yourself from Job Scams</h2>
                <p class="fjai-subtitle">Join thousands of job seekers who use AI to verify job postings before applying.</p>
            </div>
...
function showWelcomeSuccess(email) {
    ...
    body.innerHTML = `
        <div class="fjai-success">
            ...
            <p>Welcome to FakeJobAI. Start scanning jobs now.</p>
